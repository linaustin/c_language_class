...
int main()
{
    ...
    int player1Ball, computerBall, player2Ball, computerStep = 0,firstStep=0;
    ...
    if(playerNumber==1)
    {
      printf("if computer first enter 1 ,if player first enter 0\n");
      scanf("%d",&firstStep);

    }


    while (playerNumber == 1 && firstStep==0)
    {
    ...
    while (playerNumber == 1 && firstStep==1)
    {
